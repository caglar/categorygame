...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		MainWindow.resize(449, 375)

		self.centralwidget = QtGui.QWidget(MainWindow)
		self.centralwidget.setObjectName("centralwidget")

		self.gridLayoutWidget = QtGui.QWidget(self.centralwidget)
		self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 449, 348))
		...
		self.chkLoglog = QtGui.QCheckBox(self.frame)
		self.chkLoglog.setGeometry(QtCore.QRect(150, 260, 181, 21))
		self.chkLoglog.setObjectName("chkLoglog")


		self.btnStart = QtGui.QPushButton(self.frame)
		self.btnStart.setGeometry(QtCore.QRect(150, 290, 85, 27))
	...
	def retranslateUi(self, MainWindow):
		...
		self.chkLoglog.setText(QtGui.QApplication.translate("MainWindow", "Draw Log Log Plot", None, QtGui.QApplication.UnicodeUTF8))
